...
def render_how_to():
    ...
    The Field Guide turns the Texas Top 24 Research workbook into short district refresh cards for live conversations, plus deeper Word exports for planning.
    </div>
    """, unsafe_allow_html=True)
...
if not uploaded_file:
    ...
    with tab_howto:
        render_how_to()
    with tab_matrix:
        st.info("Upload a workbook to populate the matrix.")
    with tab_diag:
